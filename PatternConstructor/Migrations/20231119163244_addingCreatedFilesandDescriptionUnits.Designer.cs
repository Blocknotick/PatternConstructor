...
namespace PatternConstructor.Migrations
{
    ...
    [Migration("20231119163244_addingCreatedFilesandDescriptionUnits")]
    partial class addingCreatedFilesandDescriptionUnits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatternConstructor.Models.CreatedFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DescribtionLink")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("CreatedFiles");
                });

            modelBuilder.Entity("PatternConstructor.Models.DescriptionUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DescriptionUnits");
                });

            modelBuilder.Entity("PatternConstructor.Models.FavoriteArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatternConstructor.Models.CreatedFile", b =>
                {
                    b.HasOne("PatternConstructor.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("PatternConstructor.Models.FavoriteArticle", b =>
                {
                    b.HasOne("PatternConstructor.Models.Article", "Article")
                        .WithMany()
